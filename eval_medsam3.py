...
from models.medsam3_adapter import MedSAM3Segmenter, PROMPT_TEMPLATES, volume_to_uint8
...
def evaluate(cfg: dict, config_path: str | None, weights_path: str | None,
    ...
    for label_val in eval_labels:
        ...
        for qsid in query_sids:
            ...
            seg_crop = seg.segment_volume(vol_u8, prompt)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--medsam3_config',  type=str, default=None,
                        help='LoRA config YAML; default = third_party/MedSAM3/configs/full_lora_config.yaml')
    parser.add_argument('--medsam3_weights', type=str, default=None,
                        help='local LoRA weights .pt; default = download lal-Joey/MedSAM3_v1 from HF hub')
